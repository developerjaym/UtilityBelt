...
export class CustomFunctionItemComponent implements OnInit {
  ...
  calcHeight(): string {
    ...
    heightString += `${HtmlBuilderService.ROW_GAP} + ${HtmlBuilderService.BUTTON_SIZE} + ${HtmlBuilderService.ROW_GAP} + ${HtmlBuilderService.BUTTON_SIZE} + ${HtmlBuilderService.ROW_GAP} + ${HtmlBuilderService.OUTPUT_SIZE} + ${HtmlBuilderService.ROW_GAP}`;
