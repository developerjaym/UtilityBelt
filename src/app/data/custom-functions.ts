...
export class CustomFunctions {
  static items: CustomFunctionItem[] = [
...

    {
      ...
      function: " try {let toBase64 = paramArray[1] === 'YES';let result =  toBase64 ? btoa(paramArray[0]) : atob(paramArray[0]);print(result);  log('SUCCESS'); } catch (e) { console.error(e); } print('');"
    },
    {
